...
//		if(cells[Player.Empty].content == thePlayer)
//			return true;
//		
//		else 
//			return false;
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[0][0].content == thePlayer && cells[0][1].content == thePlayer && cells[0][2].content == thePlayer )
			return true; 
		
		if(cells[1][0].content == thePlayer && cells[1][1].content == thePlayer && cells[1][2].content == thePlayer )
			return true; 
